...
def restart_scrape_posts(loc_id,posts_per_page,end_cursor,posts_per_file):
    #Variables iniciales
    query_hash = '36bd0f2bf5911908de389b8ceaa3be6d'
    arr_ec=[end_cursor]
    arr =[]
...
class Mainwindow(QDialog):
    def __init__(self):
        ...
        self.botonRestart.clicked.connect(self.restart_scrape_trigger) 
        self.row = 0
        self.col = 0

    def restart_scrape_trigger(self):
        ...
        end_cursor = str(self.end_cursor_entry.text())
